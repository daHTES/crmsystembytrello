...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item active">
            <a class="nav-link" href="{{ route('admin.profile') }}" wire:navigate>
                <i class="fa fa-users"></i>
                <span>Профиль админа</span></a>
        </li>
        ...
        <li class="nav-item active">
            <a class="nav-link" href="{{ route('admin.users.create') }}" wire:navigate>
                <i class="fa fa-user-plus"></i>
                <span>Создать пользователя</span></a>
        </li>
                    ...
                    <li class="nav-item dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a class="dropdown-item" href="{{ route('admin.dashboard') }}">
                                <i class="fa fa-bar-chart fa-sm fa-fw mr-2 text-gray-400"></i>
                                Панель
                            </a>
